            ...
            if let Some(visible_part) = note_rect.intersection(&frame_rect) {
                ...
                let border_color = if note.selected {
                    match map_state.current_mode {
                        ...
                        Mode::VisualSelect | Mode::VisualMove | Mode::VisualConnectAdd | Mode::VisualConnectEdit => Color::Yellow,
                ...
                let border_type = if note.selected {
                    match map_state.current_mode {
                        ...
                        Mode::VisualSelect | Mode::VisualMove | Mode::VisualConnectAdd | Mode::VisualConnectEdit => BorderType::Thick,
