...
fn test_move_note_x_positive_viewport_adjustment() {
    ...
    // Note should move
    assert_eq!(map_state.notes[&0].x, 100);
...
fn test_switch_notes_focus_no_selected_note() {
    ...
    assert!(!map_state.notes[&0].selected);
    assert!(!map_state.notes[&1].selected);
}
...
fn test_switch_notes_focus_down_j() {
    ...
    map_state.notes.insert(0, Note::new(50, 10, String::from("Top"), true, Color::White));
    map_state.notes.insert(1, Note::new(50, 30, String::from("Bottom"), false, Color::White)); // Further down
    map_state.render_order = vec![1, 0];
    map_state.selected_note = Some(0);
    ...
    assert_eq!(map_state.render_order, vec![0, 1]);
}
...
fn test_switch_notes_focus_up_k() {
    ...
    // Add notes with vertical alignment
    map_state.notes.insert(0, Note::new(50, 10, String::from("Top"), false, Color::White));
    map_state.notes.insert(1, Note::new(50, 30, String::from("Bottom"), true, Color::White));
    map_state.render_order = vec![0, 1];
    map_state.selected_note = Some(1);
    ...
    assert_eq!(map_state.render_order, vec![1, 0]);
}
...
fn test_switch_notes_focus_right_l() {
    ...
    map_state.notes.insert(0, Note::new(10, 25, String::from("Left"), true, Color::White));
    map_state.notes.insert(1, Note::new(80, 25, String::from("Right"), false, Color::White)); // Further right
    map_state.render_order = vec![1, 0];
    map_state.selected_note = Some(0);
...
fn test_switch_notes_focus_left_h() {
    ...
    // Add notes with horizontal alignment
    map_state.notes.insert(0, Note::new(10, 25, String::from("Left"), false, Color::White));
    map_state.notes.insert(1, Note::new(80, 25, String::from("Right"), true, Color::White));
    map_state.render_order = vec![0, 1];
    map_state.selected_note = Some(1);
...
fn test_switch_notes_focus_no_valid_candidate() {
    ...
    // Add only one note
    map_state.notes.insert(0, Note::new(50, 25, String::from("Only"), true, Color::White));
    map_state.selected_note = Some(0);
...
fn test_switch_notes_focus_cone_selection() {
    ...
    map_state.notes.insert(0, Note::new(50, 25, String::from("Center"), true, Color::White)); // Selected
    map_state.notes.insert(1, Note::new(60, 30, String::from("Diagonal"), false, Color::White)); // Diagonal (dx=10, dy=5, dx>dy)
    map_state.notes.insert(2, Note::new(70, 26, String::from("Right"), false, Color::White)); // More to the right (dx=20, dy=1, dx>dy)
    map_state.selected_note = Some(0);
...
fn test_switch_notes_focus_with_visual_connection() {
    ...
    // Add notes
    map_state.notes.insert(0, Note::new(10, 25, String::from("Start"), true, Color::White));
    map_state.notes.insert(1, Note::new(80, 25, String::from("End"), false, Color::White));
    map_state.selected_note = Some(0);
...
fn test_switch_notes_focus_with_visual_connection_same_note() {
    ...
    map_state.notes.insert(1, Note::new(70, 25, String::from("Too close"), false, Color::White)); 
    switch_notes_focus(&mut map_state, "l");
...
fn test_switch_notes_focus_invalid_key() {
    ...
    map_state.notes.insert(0, Note::new(50, 25, String::from("Test"), true, Color::White));
    map_state.selected_note = Some(0);
...
fn test_switch_notes_focus_arrow_keys() {
    ...
    map_state.notes.insert(0, Note::new(50, 25, String::from("Center"), true, Color::White));
    map_state.notes.insert(1, Note::new(50, 40, String::from("Down"), false, Color::White));
    map_state.notes.insert(2, Note::new(50, 10, String::from("Up"), false, Color::White));
    map_state.notes.insert(3, Note::new(80, 25, String::from("Right"), false, Color::White));
    map_state.notes.insert(4, Note::new(20, 25, String::from("Left"), false, Color::White));
    map_state.render_order = vec![1, 2, 3, 4, 0];
    map_state.selected_note = Some(0);
    ...
    map_state.selected_note = Some(0);
    map_state.notes.get_mut(&0).unwrap().selected = true;
    map_state.notes.get_mut(&1).unwrap().selected = false;
    ...
    map_state.selected_note = Some(0);
    map_state.notes.get_mut(&0).unwrap().selected = true;
    map_state.notes.get_mut(&2).unwrap().selected = false;
    switch_notes_focus(&mut map_state, "Right");
    assert_eq!(map_state.selected_note, Some(3));
    
    // Reset and test Left arrow
    map_state.selected_note = Some(0);
    map_state.notes.get_mut(&0).unwrap().selected = true;
    map_state.notes.get_mut(&3).unwrap().selected = false;
    switch_notes_focus(&mut map_state, "Left");
    assert_eq!(map_state.selected_note, Some(4));
}
