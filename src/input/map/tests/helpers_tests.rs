...
fn test_move_note_x_positive_simple() {
    ...
    map_state.notes_state.add(40, 20, String::from("Test"), true, Color::White);
...
fn test_move_note_x_positive_viewport_adjustment() {
    ...
    map_state.notes_state.add(95, 20, String::from("Test"), true, Color::White);
    map_state.notes_state.select(0);
    map_state.viewport.view_pos.x = 0;
    map_state.viewport.view_pos.y = 0;
...
fn test_move_note_x_negative_viewport_adjustment() {
    ...
    map_state.notes_state.add(5, 20, String::from("Test"), true, Color::White);
    map_state.notes_state.select(0);
...
fn test_move_note_y_positive_viewport_adjustment() {
    ...
    map_state.notes_state.add(40, 45, String::from("Test"), true, Color::White);
    map_state.notes_state.select(0);
    map_state.viewport.view_pos.x = 0;
    map_state.viewport.view_pos.y = 0;
...
fn test_move_note_y_negative_viewport_adjustment() {
    ...
    map_state.notes_state.add(40, 5, String::from("Test"), true, Color::White);
    map_state.notes_state.select(0);
    map_state.viewport.view_pos.x = 0;
    map_state.viewport.view_pos.y = 5;
...
fn test_switch_notes_focus_down_j() {
    ...
    map_state.notes_state.add(50, 10, String::from("Top"), true, Color::White);
    map_state.notes_state.add(50, 30, String::from("Bottom"), false, Color::White); // Further down
    map_state.notes_state.select(0);
...
fn test_switch_notes_focus_up_k() {
    ...
    // Add notes with vertical alignment
    map_state.notes_state.add(50, 10, String::from("Top"), false, Color::White);
    map_state.notes_state.add(50, 30, String::from("Bottom"), true, Color::White);
...
fn test_switch_notes_focus_right_l() {
    ...
    map_state.notes_state.add(10, 25, String::from("Left"), true, Color::White);
    map_state.notes_state.add(80, 25, String::from("Right"), false, Color::White); // Further right
    map_state.notes_state.select(0);
...
fn test_switch_notes_focus_left_h() {
    ...
    // Add notes with horizontal alignment
    map_state.notes_state.add(10, 25, String::from("Left"), false, Color::White);
    map_state.notes_state.add(80, 25, String::from("Right"), true, Color::White);
    map_state.notes_state.select(1);
...
fn test_switch_notes_focus_cone_selection() {
    ...
    map_state.notes_state.add(50, 25, String::from("Center"), true, Color::White); // Selected
    map_state.notes_state.add(60, 30, String::from("Diagonal"), false, Color::White); // Diagonal (dx=10, dy=5, dx>dy)
    map_state.notes_state.add(70, 26, String::from("Right"), false, Color::White); // More to the right (dx=20, dy=1, dx>dy)
    map_state.notes_state.select(0);
...
fn test_switch_notes_focus_with_visual_connection() {
    ...
    // Add notes
    map_state.notes_state.add(10, 25, String::from("Start"), true, Color::White);
    map_state.notes_state.add(80, 25, String::from("End"), false, Color::White);
    map_state.notes_state.select(0);
...
fn test_switch_notes_focus_invalid_key() {
    ...
    map_state.notes_state.add(50, 25, String::from("Test"), true, Color::White);
    map_state.notes_state.select(0);
...
fn test_switch_notes_focus_arrow_keys() {
    ...
    map_state.notes_state.add(50, 25, String::from("Center"), true, Color::White);
    map_state.notes_state.add(50, 40, String::from("Down"), false, Color::White);
    map_state.notes_state.add(50, 10, String::from("Up"), false, Color::White);
    map_state.notes_state.add(80, 25, String::from("Right"), false, Color::White);
    map_state.notes_state.add(20, 25, String::from("Left"), false, Color::White);
    map_state.notes_state.select(0);
    ...
    assert_eq!(map_state.notes_state.selected_note_id(), Some(4));
}
