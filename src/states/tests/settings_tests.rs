...
use crate::states::{
    settings::{
        BackupsInterval, RuntimeBackupsInterval, Settings, SettingsState, SettingsType, 
        SelectedToggle, BackupsErr,
        cycle_side, side_to_string, get_settings
    },
    map::Side,
};
...
// TODO: Integration tests should be added to test:
// - Full file system interactions in get_settings() function
// - save_settings() function with actual file I/O operations
// - submit_path() error cases that depend on actual file system permissions
// - Loading and saving settings files with real file system
// - Error scenarios when home directory is inaccessible
// - Testing backup functionality with real directories and files